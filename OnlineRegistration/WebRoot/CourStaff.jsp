	...
	<div class="login-page">
  		<div class="form">  
  			 <form class="login-form" action="CourStaffCTL" method="post" name="frm" >
  			 	  <table><tr><td>
  			 	   <select name="branch" >
      				<option value="cs" >Branch</option>
  					<option value="cs">Computer Science</option>
  					<option value="me">Mechanical Engineering</option>
  					<option value="ee">Electrical Engineering</option>
				   </select></td>
				   <td>
				   <select name="sem" style="padding-right: 0px; padding-left: 0px;">
				   ...
				   <td> <button value="delete" name="operation">Delete</button></td>
				   <td> <button value="update" name="operation">Update</button></td>
				   </tr>
				   </table>
				   </form>
				   </div>
